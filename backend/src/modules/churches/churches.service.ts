  ...
  async create(dto: CreateChurchDto) {
    ...
    return this.prisma.church.create({
      data: {
        ...
        city: dto.city,
        address: dto.address,
        responsiblePriest: dto.responsiblePriest,
        priestPhone: dto.priestPhone,
  ...
  async update(id: string, dto: UpdateChurchDto) {
    ...
    return this.prisma.church.update({
      ...
      data: {
        ...
        ...(dto.responsiblePriest !== undefined && { responsiblePriest: dto.responsiblePriest }),
        ...(dto.priestPhone !== undefined && { priestPhone: dto.priestPhone }),
