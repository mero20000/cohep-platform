...
const BADGES = [
  ...
  },
  {
    ...
    descriptionAr: 'تجميع 1000 نقطة إجمالاً',
    iconUrl: '🥈',
    category: 'points',
    xpReward: 500,
    criteria: { rule: 'points_total', points: 1000 },
  },
  {
    name: 'Point Legend',
    nameAr: 'أسطورة النقاط',
    description: 'Accumulate 1500 total points',
    descriptionAr: 'تجميع 1500 نقطة إجمالاً',
    iconUrl: '🏅',
    category: 'points',
    xpReward: 650,
    criteria: { rule: 'points_total', points: 1500 },
  },
  {
    name: 'Point Master',
    nameAr: 'سيد النقاط',
